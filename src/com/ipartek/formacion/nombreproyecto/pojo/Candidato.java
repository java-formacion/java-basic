...
public class Candidato extends Persona {
	...
	// Constantes
	/**
	 * NOTA_MINIMA {@code int} constante que guarda la nota m�nima que se puede
	 * asignar
	 */
	public static final int NOTA_MINIMA = 0;
	/**
	 * NOTA_MAXIMA {@code int} constante que guarda la nota m�xima que se puede
	 * asignar
	 */
	...
	/**
	 * M�todo estaAceptado nos indica si un Candidato2 est� aceptado Para ello,
